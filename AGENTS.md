...
- **Deterministic Technical Debt Prevention & Zero-Slack Ratchets (v8.15.13)**: Để chặn đứng nguy cơ trôi dạt tài liệu, phình to file và rò rỉ trạng thái máy khi codebase tiến hóa:
