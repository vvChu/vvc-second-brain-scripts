...
# Monotonic line budget ratchets for legacy production files > 350 lines (22 files).
...
# Monotonic function count ratchets for legacy files with functions > 50 lines (76 files).
