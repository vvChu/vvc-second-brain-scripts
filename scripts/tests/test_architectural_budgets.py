...
# Monotonic line budget ratchets for legacy production files > 350 lines (4 files).
...
# Monotonic function count ratchets for legacy files with functions > 50 lines (59 files).
