...
> [!NOTE]
> **Định tuyến chuẩn hóa:** Kỹ năng này là Alias tương thích ngược (Backward Compatibility) của [`/ccba-contribute-to-hub`](../SKILL.md).
> - Để đề xuất **Ý tưởng / RFC / Báo lỗi**, sử dụng: [`/ccba-issue-to-hub`](../../ccba-issue-to-hub/SKILL.md).
> - Để đóng gói **Mã nguồn / Tests / Mở PR**, sử dụng: [`/ccba-contribute-to-hub`](../SKILL.md).

---

## Quy Trình Thực Thi:
Vui lòng tham khảo chi tiết toàn bộ các bước tại [`ccba-contribute-to-hub`](../SKILL.md):
...
6. **Bước 6:** Báo cáo hoàn tất & Sẵn sàng cho Maintainer thẩm định (`/ccba-contribute-to-hub`).
